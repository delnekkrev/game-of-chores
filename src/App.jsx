...
export const DAILY_TASKS = [
  ...
  { id: 'feed-dog',        name: 'Feed the Dog',        emoji: '🐶', points:  5, time: 'morning',   desc: 'Food and fresh water' },
  { id: 'drink-water',     name: 'Drink Water',         emoji: '💧', points:  5, time: 'morning',   desc: 'At least one big glass' },
  ...
  { id: 'walk-dog',        name: 'Walk the Dog',        emoji: '🦮', points: 15, time: 'afternoon', desc: 'At least 15 minutes outside' },
  { id: 'clean-room',      name: 'Clean Room',          emoji: '🧹', points: 15, time: 'afternoon', desc: 'Floor clear, clothes put away' },
  { id: 'vacuum',          name: 'Vacuum',              emoji: '🌀', points: 15, time: 'afternoon', desc: "Full room, don't miss corners" },
  { id: 'laundry',         name: 'Laundry',             emoji: '🫧', points: 15, time: 'afternoon', desc: 'Wash, dry, and put away' },
  { id: 'ai-video',        name: 'Make AI Video',       emoji: '🎬', points: 30, time: 'afternoon', desc: 'At least 15 minutes of creating' },
  ...
  { id: 'shower',          name: 'Shower',              emoji: '🚿', points: 15, time: 'evening',   desc: 'Soap up, shampoo — the full deal!' },
